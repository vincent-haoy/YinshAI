...
current_path=`c:/Users/Administrator/Desktop/comp90054-yinsh-project-group-32`
docker_cmd="winpty docker run -it --rm --cpus=${CPU_limit} --memory=${RAM_limit} --name ${container_name} -v ${current_path}:/code ${image_name}:${image_tag} $*"
